...
cat /dev/null > $AMPACHEDIR/docker/log/6php74.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php74s.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php80.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php80s.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php81.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php81s.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php82.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php82s.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php83.log
...
cat /dev/null > $AMPACHEDIR/docker/log/6php83s.log
