...
if [ ! -d $AMPACHEDIR/releases/8/php82 ]; then
  git clone -b $RELEASEBRANCH https://github.com/ampache/ampache.git php82
fi
if [ ! -f $AMPACHEDIR/releases/8/php82/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php82
  git clone -b $RELEASEBRANCH https://github.com/ampache/ampache.git php82
fi
if [ ! -d $AMPACHEDIR/releases/8/php82_squashed ]; then
  git clone -b $SQUASHBRANCH https://github.com/ampache/ampache.git php82_squashed
fi
if [ ! -f $AMPACHEDIR/releases/8/php82_squashed/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php82_squashed
  git clone -b $SQUASHBRANCH https://github.com/ampache/ampache.git php82_squashed
fi
if [ ! -d $AMPACHEDIR/releases/8/php82_client ]; then
  git clone -b $CLIENTBRANCH https://github.com/ampache/ampache.git php82_client
fi
if [ ! -f $AMPACHEDIR/releases/8/php82_client/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php82_client
  git clone -b $CLIENTBRANCH https://github.com/ampache/ampache.git php82_client
fi

if [ ! -d $AMPACHEDIR/releases/8/php83 ]; then
  git clone -b $RELEASEBRANCH https://github.com/ampache/ampache.git php83
fi
if [ ! -f $AMPACHEDIR/releases/8/php83/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php83
  git clone -b $RELEASEBRANCH https://github.com/ampache/ampache.git php83
fi
if [ ! -d $AMPACHEDIR/releases/8/php83_squashed ]; then
  git clone -b $SQUASHBRANCH https://github.com/ampache/ampache.git php83_squashed
fi
if [ ! -f $AMPACHEDIR/releases/8/php83_squashed/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php83_squashed
  git clone -b $SQUASHBRANCH https://github.com/ampache/ampache.git php83_squashed
fi
if [ ! -d $AMPACHEDIR/releases/8/php83_client ]; then
  git clone -b $CLIENTBRANCH https://github.com/ampache/ampache.git php83_client
fi
if [ ! -f $AMPACHEDIR/releases/8/php83_client/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php83_client
  git clone -b $CLIENTBRANCH https://github.com/ampache/ampache.git php83_client
fi

if [ ! -d $AMPACHEDIR/releases/8/php84 ]; then
  git clone -b $RELEASEBRANCH https://github.com/ampache/ampache.git php84
fi
if [ ! -f $AMPACHEDIR/releases/8/php84/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php84
  git clone -b $RELEASEBRANCH https://github.com/ampache/ampache.git php84
fi
if [ ! -d $AMPACHEDIR/releases/8/php84_squashed ]; then
  git clone -b $SQUASHBRANCH https://github.com/ampache/ampache.git php84_squashed
fi
if [ ! -f $AMPACHEDIR/releases/8/php84_squashed/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php84_squashed
  git clone -b $SQUASHBRANCH https://github.com/ampache/ampache.git php84_squashed
fi
if [ ! -d $AMPACHEDIR/releases/8/php84_client ]; then
  git clone -b $CLIENTBRANCH https://github.com/ampache/ampache.git php84_client
fi
if [ ! -f $AMPACHEDIR/releases/8/php84_client/index.php ]; then
  rm -rf $AMPACHEDIR/releases/8/php84_client
  git clone -b $CLIENTBRANCH https://github.com/ampache/ampache.git php84_client
fi
...
cd $AMPACHEDIR/releases/8/php82 && git fetch origin $RELEASEBRANCH && git checkout -f $RELEASEBRANCH && git reset --hard origin/$RELEASEBRANCH && git pull
cd $AMPACHEDIR/releases/8/php82_squashed && git fetch origin $SQUASHBRANCH && git checkout -f $SQUASHBRANCH && git reset --hard origin/$SQUASHBRANCH && git pull
cd $AMPACHEDIR/releases/8/php82_client && git fetch origin $CLIENTBRANCH && git checkout -f $CLIENTBRANCH && git reset --hard origin/$CLIENTBRANCH && git pull
cd $AMPACHEDIR/releases/8/php83 && git fetch origin $RELEASEBRANCH && git checkout -f $RELEASEBRANCH && git reset --hard origin/$RELEASEBRANCH && git pull
cd $AMPACHEDIR/releases/8/php83_squashed && git fetch origin $SQUASHBRANCH && git checkout -f $SQUASHBRANCH && git reset --hard origin/$SQUASHBRANCH && git pull
cd $AMPACHEDIR/releases/8/php83_client && git fetch origin $CLIENTBRANCH && git checkout -f $CLIENTBRANCH && git reset --hard origin/$CLIENTBRANCH && git pull
cd $AMPACHEDIR/releases/8/php84 && git fetch origin $RELEASEBRANCH && git checkout -f $RELEASEBRANCH && git reset --hard origin/$RELEASEBRANCH && git pull
cd $AMPACHEDIR/releases/8/php84_squashed && git fetch origin $SQUASHBRANCH && git checkout -f $SQUASHBRANCH && git reset --hard origin/$SQUASHBRANCH && git pull
cd $AMPACHEDIR/releases/8/php84_client && git fetch origin $CLIENTBRANCH && git checkout -f $CLIENTBRANCH && git reset --hard origin/$CLIENTBRANCH && git pull
...
# php 8.2
cd $AMPACHEDIR/releases/8/php82
rm -rf vendor/* public/lib/components/*
...
cd $AMPACHEDIR/releases/8/php82_squashed
rm -rf vendor/* ./lib/components/* ./docker/
php8.2 $COMPOSERPATH install || exit 1
npm install || exit 1
npm run build || exit 1
...
cd $AMPACHEDIR/releases/8/php82_client
rm -rf vendor/* public/client/lib/components/*
php8.2 $COMPOSERPATH install || exit 1
npm install || exit 1
npm run build || exit 1
...
# php 8.3
cd $AMPACHEDIR/releases/8/php83
rm -rf vendor/* public/lib/components/*
...
cd $AMPACHEDIR/releases/8/php83_squashed
rm -rf vendor/* ./lib/components/* ./docker/
php8.3 $COMPOSERPATH install || exit 1
npm install || exit 1
npm run build || exit 1
...
cd $AMPACHEDIR/releases/8/php83_client
rm -rf vendor/* public/client/lib/components/*
php8.3 $COMPOSERPATH install || exit 1
npm install || exit 1
npm run build || exit 1
...
# php 8.4
sed -i 's/"scn\/phptal": "\^4"/"scn\/phptal": "dev-master"/g' $AMPACHEDIR/releases/8/php84/composer.json
cd $AMPACHEDIR/releases/8/php84
rm -rf vendor/* public/lib/components/*
...
sed -i 's/"scn\/phptal": "\^4"/"scn\/phptal": "dev-master"/g' $AMPACHEDIR/releases/8/php84_squashed/composer.json
cd $AMPACHEDIR/releases/8/php84_squashed
rm -rf vendor/* ./lib/components/* ./docker/
php8.4 $COMPOSERPATH update
php8.4 $COMPOSERPATH install || exit 1
npm install || exit 1
...
sed -i 's/"scn\/phptal": "\^4"/"scn\/phptal": "dev-master"/g' $AMPACHEDIR/releases/8/php84_client/composer.json
cd $AMPACHEDIR/releases/8/php84_client
rm -rf vendor/* public/client/lib/components/*
php8.4 $COMPOSERPATH update
php8.4 $COMPOSERPATH install || exit 1
npm install || exit 1
...
# php 8.5
sed -i 's/"scn\/phptal": "\^4"/"scn\/phptal": "dev-master"/g' $AMPACHEDIR/releases/8/php85/composer.json
...
sed -i 's/"scn\/phptal": "\^4"/"scn\/phptal": "dev-master"/g' $AMPACHEDIR/releases/8/php85_squashed/composer.json
...
sed -i 's/"scn\/phptal": "\^4"/"scn\/phptal": "dev-master"/g' $AMPACHEDIR/releases/8/php85_client/composer.json
...
cd $AMPACHEDIR/releases/8/generic_squashed && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./rest/.htaccess --exclude=./play/.htaccess --exclude=./channel/.htaccess ./../../ampache-${RELEASEVERSION}_squashed.zip ./ ./
cd $AMPACHEDIR/releases/8/generic_client && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../../ampache-${RELEASEVERSION}_client.zip ./

## php 8.2
cd $AMPACHEDIR/releases/8/php82 && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../..//ampache-${RELEASEVERSION}_all_php8.2.zip ./
cd $AMPACHEDIR/releases/8/php82_squashed && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./rest/.htaccess --exclude=./play/.htaccess --exclude=./channel/.htaccess ./../../ampache-${RELEASEVERSION}_all_php8.2_squashed.zip ./
cd $AMPACHEDIR/releases/8/php82_client && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../..//ampache-${RELEASEVERSION}_all_php8.2_client.zip ./

## php 8.3
cd $AMPACHEDIR/releases/8/php83 && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../..//ampache-${RELEASEVERSION}_all_php8.3.zip ./
cd $AMPACHEDIR/releases/8/php83_squashed && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./rest/.htaccess --exclude=./play/.htaccess --exclude=./channel/.htaccess ./../../ampache-${RELEASEVERSION}_all_php8.3_squashed.zip ./
cd $AMPACHEDIR/releases/8/php83_client && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../..//ampache-${RELEASEVERSION}_all_php8.3_client.zip ./

## php 8.4
cd $AMPACHEDIR/releases/8/php84 && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../..//ampache-${RELEASEVERSION}_all_php8.4.zip ./
cd $AMPACHEDIR/releases/8/php84_squashed && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./rest/.htaccess --exclude=./play/.htaccess --exclude=./channel/.htaccess ./../../ampache-${RELEASEVERSION}_all_php8.4_squashed.zip ./
cd $AMPACHEDIR/releases/8/php84_client && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../..//ampache-${RELEASEVERSION}_all_php8.4_client.zip ./

## php 8.5
cd $AMPACHEDIR/releases/8/php85 && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../..//ampache-${RELEASEVERSION}_all_php8.5.zip ./
cd $AMPACHEDIR/releases/8/php85_squashed && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./rest/.htaccess --exclude=./play/.htaccess --exclude=./channel/.htaccess ./../../ampache-${RELEASEVERSION}_all_php8.5_squashed.zip ./
cd $AMPACHEDIR/releases/8/php85_client && zip -r -q -u -9 --exclude=./config/ampache.cfg.php --exclude=./docker/* --exclude=./.git/* --exclude=./.github/* --exclude=./.tx/* --exclude=./.idea/* --exclude=.gitignore --exclude=.gitattributes --exclude=.scrutinizer.yml --exclude=CNAME --exclude=.codeclimate.yml --exclude=.php* --exclude=.tgitconfig --exclude=.travis.yml --exclude=./public/rest/.htaccess --exclude=./public/play/.htaccess --exclude=./public/channel/.htaccess ./../..//ampache-${RELEASEVERSION}_all_php8.5_client.zip ./
